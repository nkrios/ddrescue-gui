    ...
    def GetVendor(self, Disk, DiskIsPartition, DiskLineNumber=None, VendorInfoList=None):
        ...
        if Linux:
            ...
            if DiskIsPartition:
                ...
                Vendor = VendorInfoList[-1]

                if "Host Device:" not in Vendor:
        ...
        if Linux:
            ...
            if DiskIsPartition:
                ...
                try:
                    ...
                    Product = "Unknown"
                    logger.warning("GetDevInfo: Main().GetProduct(): Couldn't find product info!")
    ...
    def GetSize(self, Disk, DiskLineNumber=None):
        ...
        if Linux:
            ...
            try:
                ...
                Size = "Unknown"
                logger.warning("GetDevInfo: Main().GetSize(): Couldn't find size info!")
    ...
    def GetInfo(self):
        ...
        for Disk in DiskList:
            ...
            if Linux:
                ...
                Vendor = self.GetVendor(Disk, DiskIsPartition, VendorInfoList=VendorInfoList)
